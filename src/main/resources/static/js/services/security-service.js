...
angular.module('secure-angular-app.security-service', [
	'ngResource'
])
...
.factory('securityService', ['$rootScope', '$location', 'securityEndpoints', 'alertService', 'basicAuthEndpoint', 'base64', function ($rootScope, $location, securityEndpoints, alertService, basicAuthEndpoint, base64) {
